...
(function(window, document, $) {
    ...
    ********************************************/
     ...
     ********************************************/
        //Get the context of the Chart canvas element we want to select
    var erpChartjs = document.getElementById("erp-chartjs").getContext("2d");
    // Create Linear Gradient
    var blue_trans_gradient = erpChartjs.createLinearGradient(0, 0, 0, 100);
    blue_trans_gradient.addColorStop(0, 'rgba(30,159,242,0.4)');
    blue_trans_gradient.addColorStop(1, 'rgba(255,255,255,0)');
    // Chart Options
    var ERPStats = {
    ...
    // Create the chart
    var ERPAreaChart = new Chart(erpChartjs, ERPCardconfig);
